	...
	return (
		<Grid container>
			<Grid item xs={6}>
				<Card sx={{ maxWidth: 345 }}>
					<CardHeader
						avatar={
							<Avatar
								...
								aria-label="recipe"
								alt="Remy Sharp"
								src={`https://image.tmdb.org/t/p/w500${currentUser.avatar.tmdb.avatar_path}`}
							>
								R
							</Avatar>
						}
					...
					<CardMedia
						component="img"
						height="194"
						image={`https://image.tmdb.org/t/p/w500${currentUser.avatar.tmdb.avatar_path}`}
						alt="Paella dish"
					/>
					<CardContent>
			...
			<Grid item xs={6}>
				...
				Molestias itaque aperiam a, accusantium ducimus obcaecati
				earum id, laudantium non quasi omnis voluptatibus maiores, nam
				enim repellat quaerat soluta. Cum, quod?
			</Grid>
		</Grid>
	);
}
